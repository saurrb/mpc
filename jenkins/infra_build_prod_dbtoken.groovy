...
def terraformbuild() {
    ...
    script {
        dir('terraform_databricks_scope'){
            withVaultSecrets( credentialsId: "VAULT_APPROLE_SECRET_EXPLORER", //VAULT_APPROLE_SECRET is added to the Jenkins instance.
                ...
                sh '''
                                                ...
                                                terraform plan -var-file="env/${TFENV}/global.tfvars" -var-file="env/${TFENV}/backend.tfvars" -out=${TFAPP}-${TFENV}-tfplan
...
pipeline() {
    ...
    environment {
        EMAIL_RECIPIENTS = 'subramanian_anantha@optum.com;kumar_saurabh2@optum.com;'
